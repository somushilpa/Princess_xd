...
OWNER_USERNAME = getenv("OWNER_USERNAME","Satya_Rajput_99")
...
OWNER_ID = int(getenv("OWNER_ID", 6105670951))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+PLTbaq9LInMxZjhl")
